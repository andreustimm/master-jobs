 ...
 *     continuar funcionando, e continua: num processo local o adapter de
 *     console imprime o link no terminal, que é como este projeto já entregava
 *     o link mágico; em deployment o adapter que omite só avisa, porque lá o
 *     log é lido por outras pessoas e o link é credencial.
 *
