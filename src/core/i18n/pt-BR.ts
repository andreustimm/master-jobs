...
export const ptBR = {
  ...
  jobs: {
    ...
    payConverted: "≈ {amount}",
    hiddenBelowMinimum: "{count} vagas com salário abaixo do mínimo ficaram de fora.",
  ...
  filterNotices: {
    ...
    pay_invalid: "O salário mínimo precisa ser um número inteiro de 1 a 10.000.000; o filtro foi ignorado.",
