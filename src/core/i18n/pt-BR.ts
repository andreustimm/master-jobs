...
export const ptBR = {
  ...
  onboarding: {
    ...
    nameTooLong: "O nome passa de 120 caracteres.",
    headlineTooLong: "A headline passa de 200 caracteres.",
    locationTooLong: "A localização passa de 120 caracteres.",
    cvTooShort: "O texto é curto demais para ser um currículo (mínimo 100 caracteres). Deixe em branco para colar depois.",
