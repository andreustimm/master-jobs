...
export const ptBR = {
  ...
  jobs: {
    ...
    matchedIn: "casou em: {fields}",
    matchTitle: "cargo",
    matchCompany: "empresa",
  ...
  filters: {
    ...
    searchHint: "Palavra inteira no cargo, na empresa, na localização e na descrição: “java” não traz “JavaScript”. Entre aspas, a frase exata.",
    track: "trilha",
  ...
  operations: {
    ...
    platformsLink: "Plataformas: cadastrar, sondar e buscar por fonte",
    runsLink: "Execuções: histórico de captura e verificação",
  },
  platforms: {
    title: "Plataformas",
    lead: "O catálogo de fontes que o sync varre. Cadastre um board, sonde antes de habilitar e peça a captura de uma fonte só.",
    back: "← plataformas",
    empty: "Nenhuma fonte no catálogo ainda. Cadastre a primeira abaixo, ou importe o config/sources.yaml pela CLI (jho sources import).",
    registerTitle: "Cadastrar fonte",
    kind: "Tipo",
    handle: "Handle",
    label: "Rótulo",
    secretRef: "Variável da credencial (o nome, nunca o valor)",
    enableNow: "Habilitar já",
    register: "Cadastrar",
    registered: "Fonte cadastrada.",
    enabled: "habilitada",
    disabled: "desabilitada",
    retired: "aposentada",
    managed: "gerida pelo banco",
    mirrors: "espelha o YAML",
    lastSync: "Última captura",
    never: "nunca",
    jobs: "vagas",
    open: "Abrir",
    capabilities: "Capacidades",
    snapshotComplete: "lista completa: fecha por ausência",
    snapshotPartial: "janela parcial: não fecha por ausência",
    snapshotUnknown: "completude desconhecida",
    termSearchYes: "busca por termo validada",
    termSearchNo: "sem busca por termo",
    verifyYes: "verificação de link",
    statusReasonNo: "motivo de encerramento indisponível: nenhum adaptador prova",
    probe: "Sondar",
    probeHint: "Sondar lê o board uma vez e não grava vaga nem saúde.",
    ...
    disabledSaved: "Fonte desabilitada.",
    retire: "Aposentar",
    retireConfirm: "Entendo que a fonte sai de toda execução; vagas e execuções anteriores continuam legíveis.",
    retireNeedsConfirm: "Marque a confirmação para aposentar.",
    retiredSaved: "Fonte aposentada.",
    captureNow: "Buscar agora",
    verifyNow: "Atualizar status",
    runsTitle: "Execuções desta fonte",
    errorUnknownKind: "Tipo sem adaptador.",
    errorHandleInvalid: "Handle inválido para este tipo.",
    errorHandleTooLong: "Handle acima do limite de 300 caracteres.",
    errorHandleReserved: "Handles que começam com ~ pertencem à captura por termo.",
    errorLabelEmpty: "Informe um rótulo.",
    errorLabelTooLong: "Rótulo acima do limite de 120 caracteres.",
    errorDuplicate: "Esta fonte já está no catálogo.",
    errorSecretInvalid: "Informe o nome de uma variável de ambiente (ex.: ACME_TOKEN).",
    errorSecretLooksLikeSecret: "Isso parece uma chave. Informe só o nome da variável; o valor nunca é gravado.",
    errorRetired: "Fonte aposentada ou fora do catálogo.",
    errorDisabled: "Fonte desabilitada: habilite antes de pedir.",
    errorNotFound: "Fonte fora do catálogo.",
    errorIngestionBlocked: "Este ambiente não sonda fontes externas (só produção, ou opt-in local).",
  },
  runs: {
    title: "Execuções",
    lead: "Cada captura e verificação pedida pelo catálogo, com escopo, contagens e erro. Pedir não espera a rede: a execução roda fora daqui.",
    back: "← execuções",
    empty: "Nenhuma execução registrada ainda.",
    captureAll: "Buscar em todas",
    verifyAll: "Atualizar status de todas",
    requested: "Execução criada.",
    retry: "Tentar de novo",
    retried: "Nova tentativa criada.",
    notRetryable: "Só execução que terminou sem sucesso aceita nova tentativa.",
    ...
    statusInterrupted: "interrompida",
    scopeSource: "uma fonte",
    scopeAll: "todas as fontes",
    scopeVerify: "verificação",
    fetched: "lidas",
    inserted: "novas",
    updated: "atualizadas",
    unchanged: "iguais",
    ...
    reasonWaitingSlot: "Aguardando vaga de execução.",
    reasonDispatchRejected: "O executor recusou o despacho.",
    reasonDispatchFailed: "O despacho falhou na rede; o próximo pedido tenta de novo.",
    reasonWorkFailed: "A fonte falhou nesta execução.",
    reasonChildrenFailed: "Parte das fontes falhou; as outras seguem abaixo.",
    reasonLeaseExpired: "O executor parou de responder.",
    page: "Página {page} de {pages}",
    previous: "Anterior",
    next: "Próxima",
    termCaptures: "A captura por termo aparece só como agregado, na tela de capturas.",
    termCapturesLink: "Ver capturas por termo",
  },
  admin: {
    title: "Usuários",
    nav: "Usuários",
  ...
  /** Minha conta (#236): a própria conta, qualquer papel. */
  account: {
    title: "Minha conta",
    nav: "Minha conta",
    lead: "Seus dados de acesso. O que você muda aqui vale só para a sua conta.",
    profileTitle: "Dados",
    fullName: "Nome de exibição",
    fullNameHint: "É o nome que aparece no topo depois de entrar.",
    email: "E-mail",
    emailHint: "O e-mail é o seu login e o destino da recuperação de senha. Para trocá-lo, peça a um admin.",
    saveName: "Salvar nome",
    nameSaved: "Nome salvo.",
    nameRequired: "Informe o nome de exibição.",
    passwordTitle: "Senha",
    passwordLead: "Ao trocar, todas as outras sessões desta conta são encerradas; este navegador continua conectado.",
    ...
    errorInvalid: "Senha atual incorreta.",
    errorWeak: "Senha nova curta demais. Use pelo menos 12 caracteres.",
    errorMismatch: "A confirmação não é igual à senha nova.",
    errorRateLimited: "Tentativas demais. Espere 15 minutos e tente de novo.",
    errorUnavailable: "Não foi possível conferir a senha agora. Tente de novo em instantes.",
    noPassword: "Esta conta entra só por link e ainda não tem senha. Use \"Esqueci minha senha\" na tela de entrada para definir uma.",
    borrowed: "Sessão emprestada: a conta de outra pessoa não pode ter senha, e-mail nem nome alterados daqui.",
  },
  ...
  /** Criar o próprio perfil de candidato (#234). */
  onboarding: {
    title: "Criar meu perfil",
    lead: "Sua conta ainda não tem um perfil de candidato. Crie o seu para guardar o currículo, acompanhar o funil e receber o ranking das vagas.",
    name: "Nome",
    nameHint: "Como você quer ser chamado no perfil.",
    headline: "Headline",
    headlineHint: "Uma linha sobre o que você faz. Opcional.",
    location: "Localização",
    locationHint: "Cidade e país, por exemplo. Opcional.",
    cv: "Currículo",
    cvHint: "Opcional. Cole o texto em markdown ou texto simples, ou envie o PDF abaixo — um dos dois.",
    cvPdf: "Ou envie o currículo em PDF",
    cvPdfHint: "Até {max} MB. O texto extraído vira a primeira versão do currículo, e você o revisa no editor logo depois de criar o perfil.",
    privateNote: "O perfil nasce privado: só você o vê até mudar a visibilidade.",
    submit: "Criar perfil",
    created: "Perfil criado.",
    createdFromPdf: "Perfil criado. Revise o texto extraído do PDF no editor do currículo.",
    cvBoth: "Escolha um: cole o texto ou envie o PDF, não os dois.",
    pdfMissing: "Selecione um arquivo PDF.",
    pdfTooLarge: "O PDF passa de {max} MB.",
    pdfNotPdf: "O arquivo não é um PDF legível.",
    pdfNoText: "Quase nenhum texto no PDF. Se ele foi digitalizado (imagem), não há texto para ler: cole o conteúdo no campo acima.",
  ...
  jobDetail: {
    ...
    loadingSection: "Carregando esta seção…",
    ...
    historyNote: "nota",
    historyUndo: "desfazer: de {from} para {to}",
    historyUndone: "desfeito",
    groupForward: "Avançar",
    groupBack: "Voltar",
    groupClose: "Encerrar",
    stageTrail: "Estágio no funil",
    undo: "Desfazer",
    undoLatest: "Desfazer a última movimentação",
    movedTo: "Movida para {to}.",
    undoDone: "Movimentação desfeita.",
    undoUnavailable: "Não há movimentação para desfazer. A tela foi atualizada.",
  ...
  jobAnalysis: {
    ...
    lead:
      "Fatos que o anúncio sustenta, cada um com o trecho que o prova. O que o anúncio não diz aparece como desconhecido — nunca como palpite.",
    request: "Pedir análise",
    requestAgain: "Pedir nova análise",
    none: "Nenhuma análise desta vaga ainda.",
    ...
    fieldSeniority: "Nível",
    fieldEmploymentType: "Contratação",
    fieldWorkModel: "Modelo de trabalho",
    fieldLocationRestriction: "Restrição de local",
    fieldTimezone: "Fuso",
    fieldCompensation: "Remuneração",
    fieldRequiredSkills: "Exige",
    provenanceExplicit: "dito no anúncio",
    provenanceNormalized: "padronizado a partir do anúncio",
    provenanceUnknown: "o anúncio não diz",
    provenanceConflict: "o anúncio se contradiz",
    statusQueued: "na fila",
    statusRunning: "em processamento",
    statusSucceeded: "concluída",
    statusPartial: "parcial",
    statusFailed: "falhou",
    statusPausedQuota: "pausada por cota do provedor",
    statusInterrupted: "interrompida",
    adminTitle: "Tentativas (visível só para admin)",
    adminModel: "modelo {provider}/{model}",
