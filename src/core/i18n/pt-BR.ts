...
export const ptBR = {
  ...
  filterNotices: {
    ...
    scores_pending: "Suas notas ainda estão sendo calculadas. Até lá as vagas aparecem sem nota, e o filtro de Score não as esconde.",
  },
  ...
  onboarding: {
    ...
    cv: "Currículo",
    cvHint: "Opcional. Cole o texto em markdown ou texto simples; dá para importar de PDF depois.",
