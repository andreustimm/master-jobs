...
Codex e OpenCode devem prefixar **todo** comando de shell com `rtk` — o proxy
que reduz a saída sem alterar o comando:
...
`CLAUDE.md` é o espelho deste arquivo para Claude Code. **Editou um,
edite o outro.**
