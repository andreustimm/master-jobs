# QA Run Report — <YYYY-MM-DDTHHMMSSffffffZ>-<nonce8> — <scope>
...
|---|---|---|---|---|---|---|---|
| J-<slug> | pass/friction/fail | pass/friction/fail | pass/friction/fail | pass/friction/fail | pass/friction/fail | pass/friction/fail | <paths / bug ids> |
...
<!-- Red gate, open Blocks-Completion/Data-Loss, or several open Trust-Damage
findings on one journey = not-ready. Otherwise, blocked human-only rows may be
ready-with-blocked-items; any other open failure = not-ready; fully green = ready. -->
