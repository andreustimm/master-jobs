...
2. Run `rtk python3 .claude/skills/agent-output-audit/scripts/discover-project-contract.py --root .` to surface candidate install/verify/build/test/lint/start commands and E2E signals.
