...
|---|---|
| sourcing | observação global de `source`, `company`, `job`, `job_page`, `verify_task`, `job_check_event`, e o orçamento diário de requisições por rotina em `request_budget` (a captura por termo já é contexto) |
