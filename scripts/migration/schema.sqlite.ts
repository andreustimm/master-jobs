// Frozen source model for migration parity checks, not used by runtime.
/**
...
export { SCRAPE_STATUSES } from "../../src/core/scrape/domain/status.ts";
export type { ScrapeStatus } from "../../src/core/scrape/domain/status.ts";
