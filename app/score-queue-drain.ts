 ...
 *
 * Quem acabou de salvar o currículo ou editar a trilha não espera o acervo ser
 * pontuado, mas também não espera a varredura do dia seguinte: a fatia começa
 * assim que a tela responde, dentro do teto da função (`SCORE_SLICE_MS`). O
 * que não couber fica na fila para a rota `/api/cron/score`.
 *
